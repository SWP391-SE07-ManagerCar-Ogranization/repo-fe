...
export const login = async (email, password) => {
  try {
    const temp = await axios.post("http://3.25.115.186/auth/login", {
      email,
      password,
    });
    return temp.data;
...
export const loginGoogle = async (userData) => {
  try {
    const temp = await axios.post(
      "http://3.25.115.186/oauth2/login",
      userData
    );
    return temp.data;
  } catch (e) {
...
export const register = async (userData) => {
  try {
    const temp = await axios.post(
      "http://3.25.115.186/auth/register",
      userData
    );
    return temp.data;
  } catch (e) {
...
export const getAllUsers = async (token) => {
  try {
    const temp = await axios.get("http://3.25.115.186/admin/get-all-users", {
...
export const getYourProfile = async (token) => {
  try {
    const temp = await axios.get(
      "http://3.25.115.186/adminuser/get-profile",
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const getFeedbackProfileDriver = async (id) => {
  try {
    const temp = await axios.get(
      `http://3.25.115.186/public/feedback-driver/find-all/${id}`
    );
    return temp.data;
  } catch (e) {
    console.log(e);
...
export const updateUser = async (userId, userData, token) => {
  try {
    const temp = await axios.put(
      `http://3.25.115.186/adminuser/update/${userId}`,
      userData,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
...
export const changePass = async (token, password) => {
  try {
    const temp = await axios.post(`http://3.25.115.186/auth/change-pass`, {
      token,
      password,
    });
    return temp.data;
