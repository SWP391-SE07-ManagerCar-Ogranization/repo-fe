...
import { getGroupsByDriverId } from "../../service/GroupCarService";
...
const GroupWorkingPage = () => {
  ...
  const handleShowChatRoom = (group) => {
    ...
    const check = groupCarsCheck?.some(
      (element) => element.id === group?.groupId
    );
    // if (check) {
      ...
      <Layout>
        ...
        >
          ...
          >
            ...
            {/* table groupCar */}
            {checkGroupCar && (
              <div className="relative overflow-x-auto sm:rounded-lg w-full sm:w-[90%] md:w-[80%] lg:w-[100%] mx-auto">
                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-gray-700 dark:text-gray-600">
                      <thead className="bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                          <th
                            scope="col"
                            className="px-6 py-3 w-1/3 text-center"
                          >
                            Customer Id
                          </th>
                          <th
