...
export default function TripInfor({ group }) {
    ...
    const { groupName, startPoint, endPoint, groupCarId } = group
    const {driverDetail, setDriverDetail, groupData,userData} = theme
    ...
    return (
        <>
            <Row>
                ...
                <Col span={24}><span className='font-semibold'>Driver:</span> {driverDetail!=null?driverDetail.name:'No exist'}</Col>
